...
const unsigned int strat_Alice[MAX_Alice-1] = {
    24, 15, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 7, 4, 2, 1, 1, 2, 1, 1, 3, 2, 1, 1, 1, 1, 9, 7, 4, 2, 1, 1, 2, 1, 1, 3, 2, 1, 1, 1,
    1, 4, 2, 1, 1, 1, 2, 1, 1
};

const unsigned int strat_Bob[MAX_Bob - 1] = {
        32, 16, 8, 4, 3, 2, 1, 1, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2,
        1, 1, 2, 1, 1, 16, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1
};
