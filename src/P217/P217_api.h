...
// Public keys pk consist of 3 elements in GF(p217^2). In the SIKE API, pk is encoded in 330 octets. 
...
// Output: the public key PublicKeyA consisting of 3 GF(p217^2) elements encoded in 330 bytes.
...
// The public key consists of 3 GF(p217^2) elements encoded in 330 bytes.
...
//         Bob's PublicKeyB consists of 3 GF(p217^2) elements encoded in 330 bytes.
// Output: a shared secret SharedSecretA that consists of one element in GF(p217^2) encoded in 110 bytes.
...
//         Alice's PublicKeyA consists of 3 GF(p217^2) elements encoded in 330 bytes.
// Output: a shared secret SharedSecretB that consists of one element in GF(p217^2) encoded in 110 bytes.
...
// Public keys PublicKeyA and PublicKeyB consist of 3 elements in GF(p217^2). In the SIDH API, they are encoded in 330 octets. 
// Shared keys SharedSecretA and SharedSecretB consist of one element in GF(p217^2). In the SIDH API, they are encoded in 110 octets.
